; (function (g, fn) {
    ...
    if (typeof require !== 'undefined') {
        if (g.$ === undefined) {
            g.$ = require('./js/jquery-1.11.3.min.js');
        }
        g.pdfjsWorker = require('./js/pdf.worker.js');
        g.pdfjsLib = require('./js/pdf.js');
    }
...
*options:如：{waterMark:"榕基软件"}
		...
		*配置项参数waterMark2019/12/26:传水印值  默认无水印 *
		*配置项参数ctrlSwiper:页签滑动函数控制 *
